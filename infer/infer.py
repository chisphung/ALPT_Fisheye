...
import sys
import argparse
from model.yolo.ultralytics.utils.nms import non_max_suppression, scale_coords
# from ai_core.object_detection.yolov5_custom.od.data.datasets import letterbox
from typing import List
# from dynaconf import settings
from model.yolo.ultralytics.engine.model import Model
import cv2
...
class Detection:
    ...
    def load_model(self,path, train = False):
        # print(self.device)
        model = Model(path, map_location=self.device)  # load FP32 model
